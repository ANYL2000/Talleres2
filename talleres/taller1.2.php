...
<tr class="filas_secundarias" id="color_gris" >
  ...
  <td><button type='submit' class='boton_editar' id='abrir_editar' name='abrir_editar' data-toggle='modal' data-target="#exampleModal<?php echo $fila['idUsuarios']; ?>">Editar</button></td>
<td><button class='boton_borrar' data-toggle='modal' data-target="#exampleModal<?php echo $fila['idUsuarios']; ?>">Eliminar</button></td>
</tr>
